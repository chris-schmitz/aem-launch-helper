...
FileSystemTools.baseJarExists = function(){
...
FileSystemTools.createEnvironmentDirectory = function(environment){
    return new Promise((resolve,reject) => {
...
FileSystemTools.copyToLocation = function(sourceFile, targetFile){
    return  new Promise((resolve, reject) => {

        try{
            // It's safe to do this for ever path. Even if it's not a `~` path
            // it just means there will be nothing for the replace to replace)
            sourceFile = sourceFile.replace(/^~/, os.homedir())
...
FileSystemTools.directoryContainsRequiredAEMFiles = function(directory){
    return new Promise((resolve,reject) => {
...
FileSystemTools.openJarFile = function(path){
    return new Promise((resolve,reject) => {
...
FileSystemTools.killProcess = function(id){
    return new Promise((resolve, reject) => {
...
FileSystemTools.pushToAEM = function(credentials, port){
    return new Promise((resolve, reject) => {
...
FileSystemTools.destroyEnvironment = function (environment){
    return new Promise((resolve, reject) => {
        let targetPath = `${appSettings.environmentBuildDirectory}/${environment}`
...
FileSystemTools.checkToSeeIfJavaRuntimeEnvIsAvailable = function (){
    return new Promise((resolve, reject) => {
...
FileSystemTools.extractVltCliTool = function (binInstallPath){
    return new Promise((resolve, reject) => {
        co(function *(){
...
FileSystemTools.checkToSeeIfVltIsInPath = function (){
    return new Promise((resolve, reject) => {
